...
import cover3 from '../assets/Project3/1.png'
...
export default function Projects() {
    ...
    const github2=()=>{
        window.open('https://github.com/ayushanandmishra/Drive','_blank');
    }
                        ...
                        <div className="project-1">
                            ...
                            <div className="formatter">
                                ...
                                <ImageOverlay
                                    ...
                                    description={<h1>Home Page of my Drive App</h1>} />
                                ...
                                <div className="description">
                                    ...
                                    <br />
                                    <p className="desc">
                                    The React frontend and Node.js backend ensure a responsive and reliable experience, making it a solution for secure and collaborative file management.
                                    </p>

                                    <h2>Technologies Used</h2>
                                    <p>
                                        <ul>
                                            <li className="list-item">AWS S3</li>
                                            <li className="list-item">AWS EC2</li>
                                    ...
                                    <Button onClick={github2} color="secondary" variant="contained">Github Link</Button>
                                </div>
